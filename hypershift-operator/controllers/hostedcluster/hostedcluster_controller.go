...
// specified in the HOSTEDCLUSTERS_NAMESPACE env var.  If the env var is empty, the default behavior is to accept all events.
func predicatesForHostedCluster() predicate.Predicate {
	hostedClustersNamespace := os.Getenv("HOSTEDCLUSTERS_NAMESPACE")
...
// exist in the namespace specified in the HOSTEDCLUSTERS_NAMESPACE env var.  If the env var is empty, the default behavior is to accept all events.
